...
const MENU = {
  matcha: {
    ...
    items: [
      ...
      { id: 'matcha-besitos', photo: '/drinks/matcha-besitos-v2.jpeg', name: 'Matcha Besitos', desc: 'Cookie butter matcha with a Biscoff crumble & soft top', priceL: 10.50, priceBucket: 19.00, gradient: 'linear-gradient(180deg, #E8C896 0%, #B5C99A 40%, #6B8E4E 100%)' },
      ...
      { id: 'matcha-rosa', photo: '/drinks/matcha-rosa-v2.jpeg', name: 'Matcha Rosa', desc: 'Strawberry matcha — jade matcha over sweet strawberry', priceL: 10.50, priceBucket: 19.00, gradient: 'linear-gradient(180deg, #B5C99A 0%, #B5C99A 45%, #FFE4D6 60%, #C8345A 100%)' },
    ],
  },
  lattes: {
    title: 'Lattes',
  ...
  refreshers: {
    ...
    items: [
      ...
      { id: 'green-chula', isNew: true, photo: '/drinks/green-chula.jpeg', name: 'Green Chula', desc: 'Green apple refresher', priceL: 8.00, priceBucket: 8.00, singleSize: true, gradient: 'linear-gradient(180deg, #E8F8D0 0%, #A5D96A 50%, #5FA02E 100%)' },
    ],
  },
  energy: {
    title: 'Energy Drinks',
    ...
    items: [
      ...
      { id: 'cremita-fuse', photo: '/drinks/cremita-fuse-v2.jpeg', name: 'Cremita Fuse', desc: 'Piña colada RedBull refresher', priceL: 8.00, priceBucket: 12.00, gradient: 'linear-gradient(180deg, #FFF5E1 0%, #F5DDB3 50%, #C9A86A 100%)' },
      { id: 'azulita-fuse', photo: '/drinks/azulita-fuse-v2.jpeg', name: 'Azulita Fuse', desc: 'Blue raspberry RedBull refresher', priceL: 8.00, priceBucket: 12.00, gradient: 'linear-gradient(180deg, #B8F0E8 0%, #5DD4C5 50%, #2BA89A 100%)' },
      { id: 'verde-fuse', photo: '/drinks/verde-fuse-v2.jpeg', name: 'Verde Fuse', desc: 'Green apple RedBull refresher', priceL: 8.00, priceBucket: 12.00, gradient: 'linear-gradient(180deg, #DEF5C9 0%, #95D478 50%, #4A9B2D 100%)' },
    ],
  },
};
